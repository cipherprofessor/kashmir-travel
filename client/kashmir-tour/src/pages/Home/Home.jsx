  ...
  const tourPackages = [
    {
      ...
      title: 'Gulmarg',
      description: 'Gulmarg is the crowning glory of Jammu & Kashmir and is located 2,650 meters above sea level. Known as the “Meadow of Flowers”, it boasts of the world’s highest golf-course.',
      price: 499,
      duration: '2 Days',
    ...
    },
    {
      ...
      title: 'Pahalgam',
      description: 'A favourite with the filmmakers for its picturesque setting against the backdrop of Lidder River, Pahalgam’s lush valleys, colourful meadows and snow-kissed mountains look like a scene straight out of a beautiful painting.',
      price: 599,
      duration: '3 Days',
    ...
    },
    {
      ...
      title: 'Sonmarg',
      description: 'Sonmarg, also known as the "Meadow of Gold," is a picturesque town located in the Indian state of Jammu and Kashmir. It is a popular tourist destination known for its scenic beauty and adventurous activities.',
      price: 699,
      duration: '4 Days',
